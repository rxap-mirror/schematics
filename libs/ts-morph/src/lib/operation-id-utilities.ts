import { classify, dasherize, HasProject } from '@rxap/schematics-utilities';
...
export function OpenApiResponseClassImportPath(response: string, serverId: string = 'legacy') {
...
export function buildOperationId(options: { project: string, feature: string, shared: boolean }, operation: string, controller: string): string {
