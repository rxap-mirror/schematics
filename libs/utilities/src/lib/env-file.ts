...
export function CoerceEnvFile(tree: Tree, content: EnvFile, filePath: string = '.env'): void {

  CoerceFile(tree, filePath, EnvMapToString(content));

}

export function MergeWithEnvFile(content: EnvFile, filePath: string = '.env'): Rule {
  return tree => {
...
export function WriteEnvFile(tree: Tree, content: EnvFile, filePath: string = '.env'): void {
...
export function GetEnvFile(tree: Tree, filePath: string = '.env'): EnvFile {
